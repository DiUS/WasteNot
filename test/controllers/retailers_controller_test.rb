...
class RetailersControllerTest < ActionController::TestCase
  ...
  test "should create retailer" do
    assert_difference('Retailer.count') do
      post :create, retailer: { bio: @retailer.bio, contact_email: @retailer.contact_email, contact_name: @retailer.contact_name, contact_phone: @retailer.contact_phone, name: @retailer.name, web_page: @retailer.web_page }
    end
  ...
  test "should update retailer" do
    patch :update, id: @retailer, retailer: { bio: @retailer.bio, contact_email: @retailer.contact_email, contact_name: @retailer.contact_name, contact_phone: @retailer.contact_phone, name: @retailer.name, web_page: @retailer.web_page }
    assert_redirected_to retailer_path(assigns(:retailer))
  end
